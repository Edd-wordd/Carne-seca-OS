...
/** Mock catalog for Add purchase item dropdown (aligned with demo purchase history). */
        ...
        <div className="space-y-4">
            ...
            >
                <DialogContent className="border-zinc-700/80 bg-zinc-900/95 backdrop-blur-xl shadow-2xl shadow-black/30 sm:max-w-xl overflow-hidden">
                    ...
                    <form onSubmit={handleAddPurchase} className="pt-3 space-y-4">
                        <div className="grid grid-cols-1 sm:grid-cols-[1fr_minmax(0,8rem)] gap-3">
                            <div>
                                ...
                                <select
                                    ...
                                    onChange={(e) => {
                                        ...
                                        setPurchaseForm((f) => {
                                            const next = { ...f, itemSelect: v };
                                            const row = MOCK_PURCHASE_ITEMS.find((x) => x.id === v);
                            ...
                            <div>
                                ...
                                <Select
                                    ...
                                    onValueChange={(v) => setPurchaseForm((f) => ({ ...f, category: v }))}
                                    disabled={Boolean(purchaseForm.itemSelect)}
                                >
                                    <SelectTrigger className="mt-1 h-9 border-zinc-700/80 bg-zinc-950/80 text-zinc-100 text-sm focus-visible:border-emerald-500/50 focus-visible:ring-2 focus-visible:ring-emerald-500/20 disabled:opacity-60">
                                        <SelectValue />
                                    </SelectTrigger>
                                    <SelectContent>
