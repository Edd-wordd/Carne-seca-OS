...
const getNormalizedStatus = (product) =>
    String(product?.status ?? '')
        .trim()
        .toLowerCase();

export default function CatalogPage({ initialProducts = [] }) {
    ...
    React.useEffect(() => () => clearPendingCloseReset(), []);
    ...
    const handleSubmitProduct = async (e) => {
        ...
        if (editingId) {
            ...
            if (!updateResult?.success) {
                setFormError(updateResult?.error ?? 'Failed to update product.');
