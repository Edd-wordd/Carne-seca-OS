...
import CreateBatchDialog from './CreateBatchDialog.jsx';
import EditBatchDialog from './EditBatchDialog.jsx';
import DamagedBatchDialog from './DamagedBatchDialog.jsx';
import ConvertBatchDialog from './ConvertBatchDialog.jsx';
import DeleteBatchDialog from './DeleteBatchDialog.jsx';
import ProductionKPIs from './ProductionKPIs.jsx';

const PAGE_SIZE = 10;

export function ProductionToolbar({ suppliers }) {
    const router = useRouter();
    return <CreateBatchDialog suppliers={suppliers} onSuccess={() => router.refresh()} />;
}

export function ProductionClient({ initialBatches = [], initialProducts = [] }) {
    const router = useRouter();
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <TableCell className="text-zinc-400 px-2 py-2.5 tabular-nums text-xs hidden xl:table-cell group-hover:text-zinc-300">
                                            {batch.initial_weight != null && batch.cost_per_pound != null
