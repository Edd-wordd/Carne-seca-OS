...
BEGIN
  ...
  INSERT INTO orders (guest_id, stripe_session_id, customer_email, amount_total, status, customer_name, source, coupon_id)
  VALUES (p_guest_id, p_stripe_session_id, p_customer_email, p_amount_total, 'paid', p_customer_name, p_source, p_coupon_id)
